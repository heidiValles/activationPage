...
(function ( $ ) {
    ...
    $.fn.mostSlider = function( options ) {
        ...
        slider.css({"position": "relative","width": "100%","line-height": "1em"});
        ...
        if(settings.animation == "slide"){
	        ...
	        slider.wrapInner('<div style="position:relative;width:100%;height:100%;" id="slides-wrapper"><div id="slides" style="position:absolute;width:100%;height:100%;overflow:hidden;line-height:1.2em;" /></div>');
        }
        else{
...
// TWITTER
!function(d,s,id){ return; var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');